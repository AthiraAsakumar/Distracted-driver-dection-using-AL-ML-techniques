...
row=64
col=64
mydata = pd.read_csv(r"/home/athira/2NN/original_TrainData.csv",header = None)
...
testimgs = glob.glob(r"/home/athira/2NN/test 500/*.jpg")
...
print(Y_pred_case)
imgLabel = pd.read_csv("/home/athira/2NN/ImageLabels.csv")
...
imgLabel.to_csv("/home/athira/2NN/ImageLabels.csv",index=False)
#41/120 correct
