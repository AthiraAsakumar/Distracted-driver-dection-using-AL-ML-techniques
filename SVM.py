...
def svm():
    mydata = pd.read_csv(r"C:\\Documents\Course material\Machine Learning\MLProject\venv\Include\trainHistograms.csv", header=None)
...
def predict(X, imgSeq):
    ...
    imgLabel = pd.read_csv(r"C:\Users\athira\Documents\Course material\Machine Learning\Project\Dataset\ImageLabels.csv")
    imgLabel["SVM"] = ''
...
imgs = glob.glob(r"C:\Users\athira\Documents\Course material\Machine Learning\Project\Dataset\imgs\Final_Test\*.jpg")
