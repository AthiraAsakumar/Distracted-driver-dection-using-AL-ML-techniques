...
def tree():
    ...
    mydata = pd.read_csv(r"D:\athira\Courses\MS WPI\Fall'19\ML\Project_Distracted Driver Detection\Code\2 NN\train_gray_64x64.csv",header = None)
...
def predict(X,imgSeq):
    ...
    imgLabel.to_csv("D:/athira/Courses/MS WPI/Fall'19/ML/Project_Distracted Driver Detection/Data/imgs/test 500/ImageLabels.csv")


row = 64        #height of the image 
col = 64        #width of the image    

imgs = glob.glob(r"D:\athira\Courses\MS WPI\Fall'19\ML\Project_Distracted Driver Detection\Data\imgs\test 500\*.jpg")
