...
def tree():
    ...
    mydata = pd.read_csv(r"D:/ML_Distracted_Driver_Detection-master/Data/driver_imgs_list.csv",header = None)
...
def predict(X,imgSeq):
    ...
    imgLabel = pd.read_csv("D:/ML_Distracted_Driver_Detection-master/Data/ImageLabels.csv")
    ...
    imgLabel.to_csv("D:/ML_Distracted_Driver_Detection-master/Data/ImageLabels.csv")


row = 64        #height of the image 
col = 64        #width of the image    

imgs = glob.glob(r"D:/ML_Distracted_Driver_Detection-master/Data/test 500/*.jpg")
